...
void \hyperlink{class_poblacion_a7024bdfa8a885c9291bb33bc66ed98ce}{escribir} () const 
\begin{DoxyCompactList}\small\item\em Escribe una población. \end{DoxyCompactList}\item 
void \hyperlink{class_poblacion_a63e97213c587bfce427b75c0fe29eace}{escribir\+\_\+genotipo} (string nombre) const 
...
\index{Poblacion@{Poblacion}!Poblacion@{Poblacion}}
\subsubsection[{\texorpdfstring{Poblacion()}{Poblacion()}}]{\setlength{\rightskip}{0pt plus 5cm}Poblacion\+::\+Poblacion (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\hypertarget{class_poblacion_ad3909b6ea27344b861b7cd548cb2b65e}{}\label{class_poblacion_ad3909b6ea27344b861b7cd548cb2b65e}
...
\subsubsection[{\texorpdfstring{anadir\+\_\+individuo(const Individuo \&ind)}{anadir_individuo(const Individuo &ind)}}]{\setlength{\rightskip}{0pt plus 5cm}void Poblacion\+::anadir\+\_\+individuo (
\begin{DoxyParamCaption}
\item[{const {\bf Individuo} \&}]{ind}
\end{DoxyParamCaption}
)}\hypertarget{class_poblacion_a4622ccceef105548460351376791f8f6}{}\label{class_poblacion_a4622ccceef105548460351376791f8f6}
...
\subsubsection[{\texorpdfstring{reproducir(string madre, string padre, string hijo, vector$<$ vector$<$ int $>$ $>$ \&matriz\+\_\+rep, const Especie \&esp)}{reproducir(string madre, string padre, string hijo, vector< vector< int > > &matriz_rep, const Especie &esp)}}]{\setlength{\rightskip}{0pt plus 5cm}void Poblacion\+::reproducir (
\begin{DoxyParamCaption}
\item[{string}]{madre, }
\item[{string}]{padre, }
\item[{string}]{hijo, }
\item[{vector$<$ vector$<$ int $>$ $>$ \&}]{matriz\+\_\+rep, }
\item[{const {\bf Especie} \&}]{esp}
\end{DoxyParamCaption}
)}\hypertarget{class_poblacion_a83e45d5057cb4496647d0aed76071876}{}\label{class_poblacion_a83e45d5057cb4496647d0aed76071876}
...
\subsubsection[{\texorpdfstring{completar\+\_\+arbol\+\_\+genealogico(queue$<$ string $>$ elem\+\_\+arb\+\_\+incom)}{completar_arbol_genealogico(queue< string > elem_arb_incom)}}]{\setlength{\rightskip}{0pt plus 5cm}void Poblacion\+::completar\+\_\+arbol\+\_\+genealogico (
\begin{DoxyParamCaption}
\item[{queue$<$ string $>$}]{elem\+\_\+arb\+\_\+incom}
\end{DoxyParamCaption}
)}\hypertarget{class_poblacion_a2dd7bd82d100852ad3767d5830fe932a}{}\label{class_poblacion_a2dd7bd82d100852ad3767d5830fe932a}
...
\subsubsection[{\texorpdfstring{leer(const Especie \&esp)}{leer(const Especie &esp)}}]{\setlength{\rightskip}{0pt plus 5cm}void Poblacion\+::leer (
\begin{DoxyParamCaption}
\item[{const {\bf Especie} \&}]{esp}
\end{DoxyParamCaption}
)}\hypertarget{class_poblacion_a94a32410a0d2b2066b0d7203efbf673f}{}\label{class_poblacion_a94a32410a0d2b2066b0d7203efbf673f}
...
\subsubsection[{\texorpdfstring{escribir() const }{escribir() const }}]{\setlength{\rightskip}{0pt plus 5cm}void Poblacion\+::escribir (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}\hypertarget{class_poblacion_a7024bdfa8a885c9291bb33bc66ed98ce}{}\label{class_poblacion_a7024bdfa8a885c9291bb33bc66ed98ce}
...
\subsubsection[{\texorpdfstring{escribir\+\_\+genotipo(string nombre) const }{escribir_genotipo(string nombre) const }}]{\setlength{\rightskip}{0pt plus 5cm}void Poblacion\+::escribir\+\_\+genotipo (
\begin{DoxyParamCaption}
\item[{string}]{nombre}
\end{DoxyParamCaption}
) const}\hypertarget{class_poblacion_a63e97213c587bfce427b75c0fe29eace}{}\label{class_poblacion_a63e97213c587bfce427b75c0fe29eace}
...
\subsubsection[{\texorpdfstring{escribir\+\_\+arbol(string ind)}{escribir_arbol(string ind)}}]{\setlength{\rightskip}{0pt plus 5cm}void Poblacion\+::escribir\+\_\+arbol (
\begin{DoxyParamCaption}
\item[{string}]{ind}
\end{DoxyParamCaption}
)}\hypertarget{class_poblacion_a44518707081153d520d7781ea7691b19}{}\label{class_poblacion_a44518707081153d520d7781ea7691b19}
